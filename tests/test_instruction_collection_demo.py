...
class InstructionCollectionDemoTests(unittest.TestCase):
    ...
    def test_collection_plan_list_and_detail_follow_pdf_contract(self):
        for expected in (
            ...
            "新建采集方案",
            'class="tn-link tn-edge-entry" href="/data/edge-collection"',
            "s026PlanIdQuery",
            "s026PlanNameQuery",
            "s026PlanType",
            "s026PlanScene",
    ...
    def test_collection_strategy_supplier_and_package_detail_follow_pdf_contract(self):
        ...
        for expected in (
            ...
            "<th>供应商 ID</th><th>供应商名称</th><th>操作</th>",
            ...
            "s026RequestDeletePlanSupplier",
            "s026DeletePlanSupplier",
            "仅解除方案关联，可重新导入",
            "重复供应商，不可导入",
        ):
    ...
    def test_independent_package_management_and_detail_flow(self):
        ...
        for expected in (
            ...
            "取消选中",
            "已导入",
            '<th>序号</th><th>指令 ID</th><th>指令名称</th><th>指令迭代</th><th>指令版本号</th><th>指令描述</th><th>指令难度</th><th>镜像</th><th>道具</th><th id="s026PackageVersionStatusHeader" hidden>状态</th><th>操作</th>',
